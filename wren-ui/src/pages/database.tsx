      ...
      <Col xs={24} lg={14}>
        <CompactPanel>
          <Descriptions column={1} size="small">
            <Descriptions.Item label="Models">{modelCount}</Descriptions.Item>
            <Descriptions.Item label="Fields">{fieldCount}</Descriptions.Item>
            <Descriptions.Item label="Relationships">
              {relationshipCount}
            </Descriptions.Item>
            <Descriptions.Item label="Views">{views.length}</Descriptions.Item>
          </Descriptions>
        </CompactPanel>
      </Col>
      <Col xs={24} lg={10}>
